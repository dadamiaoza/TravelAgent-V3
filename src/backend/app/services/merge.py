...
def _build_merge_prompt(sources: list[tuple[str, list[dict]]]) -> str:
    ...
    return (
        ...
        "- For fields like lat/lng/suggested_duration_h/best_time/cost_estimate/visit_tips: keep the first non-null value\n"
        ...
        "- All original fields from the input (poi_name, lat, lng, suggested_duration_h, best_time, cost_estimate, visit_tips)\n"
