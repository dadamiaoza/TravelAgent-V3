"""Route Optimizer Agent — Step 5 of agent learning path.

CHAINED Agent: receives itinerary_gen's output → geocodes all POIs → returns
itinerary with lat/lng filled. Real route reordering deferred to Step 7 (Amap).
